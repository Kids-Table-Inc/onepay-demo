  ...
  return (
    <>
      <Sheet open={isOpen} onOpenChange={onClose}>
        <SheetContent className="w-full sm:max-w-md border-l-0 p-0 [&_button[aria-label=Close]]:size-12 [&_button[aria-label=Close]]:focus:outline-none absolute right-0 top-0 h-full">
